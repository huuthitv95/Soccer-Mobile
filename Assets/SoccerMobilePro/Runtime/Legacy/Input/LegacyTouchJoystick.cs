namespace SoccerMobilePro.Legacy.Input
{
...
[UnityEngine.Scripting.APIUpdating.MovedFrom(true, sourceNamespace: "", sourceAssembly: "Assembly-CSharp", sourceClassName: "Joystick_2")]
public class LegacyTouchJoystick : MonoBehaviour
{
    static private LegacyTouchJoystick[] joysticks;                    // A static collection of all joysticks
    ...
    public void Update()
    {
        if (!enumeratedJoysticks)
        {
            ...
            joysticks = (LegacyTouchJoystick[])FindObjectsOfType(typeof(LegacyTouchJoystick));
        ...
        else
        {
            for (int i = 0; i < count; i++)
            {
                ...
                if (shouldLatchFinger && (lastFingerId == -1 || lastFingerId != touch.fingerId))
                {
                    ...
                    foreach (LegacyTouchJoystick j in joysticks)
                    {
                        if (j != this)
