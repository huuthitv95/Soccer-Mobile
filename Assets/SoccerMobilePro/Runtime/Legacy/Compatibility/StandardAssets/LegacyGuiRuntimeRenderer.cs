namespace SoccerMobilePro.Legacy.Compatibility
{
using System;
using UnityEngine;
...
[UnityEngine.Scripting.APIUpdating.MovedFrom(true, sourceNamespace: "", sourceAssembly: "Assembly-CSharp-firstpass", sourceClassName: "LegacyGuiRuntimeRenderer")]
public class LegacyGuiRuntimeRenderer : MonoBehaviour
{
    ...
    private void OnGUI()
    {
        ...
        bool kickOffScene = string.Equals(sceneName, SoccerMobilePro.Platform.SceneIds.Kickoff, StringComparison.Ordinal);
        if (kickOffScene)
        {
    ...
    {
        if (!string.Equals(sceneName, SoccerMobilePro.Platform.SceneIds.GameModeSelection, StringComparison.Ordinal) &&
            !string.Equals(sceneName, SoccerMobilePro.Platform.SceneIds.Kickoff, StringComparison.Ordinal))
        {
            return;
        }
