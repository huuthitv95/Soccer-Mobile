...
| T03 | Unity Technologies, tài liệu Unity 2022.3 | [Addressables content update](https://docs.unity3d.com/Packages/com.unity.addressables@1.25/manual/content-update-builds-overview.html) | Catalog/version/content update cho proposal asset delivery | Không xác nhận pipeline EA/Garena | Cao |
